...
public class MovesAPI {
	...
	private static final String mClientID = "ly0YbQ9pzd9ntGsVi0GZMB03rHwy3df5";
	private static final String mClientSecret = "Q_ajEqdN38sfrocNlgh6YC_4i3Eb4j455HA3him988Pn0txG72K7woP8TU8uzPU2";
	private static final String mClientScopes = "location activity";
	/* To which page application need to be redirected after successful login */
	private static final String mRedirectURL = "http://swin06.cs.uml.edu/processdata/";
	...
	**/
	...
	public static String getClientScopes() {
