...
public class MovesLoginFragment extends DialogFragment {
    ...
    private Uri.Builder createAuthWithAppUri(String scheme, String authority, String path) {
		//Log.e("MovesAPI", "----->" + MovesAPI.getClientDetails().getClientID());

        return new Uri.Builder()
                .scheme(scheme)
                .authority(authority)
                .path(path)
                .appendQueryParameter("client_id", MovesAPI.getClientID())
                .appendQueryParameter("redirect_uri", MovesAPI.getRedirectURL())
                .appendQueryParameter("scope", MovesAPI.getClientScopes())
